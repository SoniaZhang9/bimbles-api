...
public class PreferencesService {
	...
	public Preferences getAllPreferencesTypes() {
	    SortedSet<DietType> diets = new TreeSet<DietType>(Arrays.asList(DietType.values()));
	    SortedSet<AllergyType> allergies = new TreeSet<AllergyType>(Arrays.asList(AllergyType.values()));
	    SortedSet<SpecialNeedType> specialNeeds = new TreeSet<SpecialNeedType>(Arrays.asList(SpecialNeedType.values()));
	    
		Preferences allPreferences = new Preferences(diets, allergies, specialNeeds);
	...
	public NormalUser saveUserPreferences(Long normalUserId, Preferences preferences) {
		...
		NormalUser savedUserPreferences = normalUserRepository.save(normalUser);
